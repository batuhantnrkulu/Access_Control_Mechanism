...
contract(
  ...
  (accounts) => {
    ...
    it("should simulate token balance changes due to benign and malicious activities", async () => {
      ...
      console.log("Gas Used for Unauthorized Access:", tx.receipt.gasUsed);
      ...
      console.log(
        "Gas Used for After Unauthorized Access:",
        tx.receipt.gasUsed
      );
      ...
      console.log("Gas Used for Tampering with data:", tx.receipt.gasUsed);
      ...
      console.log("Gas Used after Tampering with data:", tx.receipt.gasUsed);
      ...
      console.log("Gas Used for too frequent access:", tx.receipt.gasUsed);
      ...
      console.log("Gas Used after too frequent access:", tx.receipt.gasUsed);
      ...
      console.log("Gas Used for denial of service:", tx.receipt.gasUsed);
      ...
      console.log("Gas Used after denial of service:", tx.receipt.gasUsed);

      tx = await accessControlContract1
        .activateContract({ from: primaryHead1 })
        .catch((e) => e);
