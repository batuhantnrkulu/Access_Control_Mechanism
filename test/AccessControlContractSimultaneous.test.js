  ...
  (accounts) => {
    ...
    it("should penalize for too frequent access and track misbehavior", async () => {
      ...
      txPromises = Promise.all([
        accessControlContract1.policyAdd(3, "test.jpg", "view", "allow", {
          from: primaryHead1,
        }),
        accessControlContract1.policyAdd(3, "test.jpg", "delete", "disallow", {
          from: primaryHead1,
        }),
        accessControlContract1.policyAdd(3, "test.jpg", "update", "disallow", {
          from: primaryHead1,
        }),
      ]);

      let results = await txPromises; // Wait for all transactions to complete
      ...
      console.log(
        `Total Execution Time for 3 policyAdd transactions: ${totalExecutionTime} ms`
      );
      ...
      tx = txPromises = Promise.all([
        accessControlContract1.accessControl("test.jpg", "view", {
          from: secondaryGroupHead1,
        }),
        accessControlContract1.accessControl("test.jpg", "delete", {
          from: secondaryGroupHead1,
        }),
        accessControlContract1.accessControl("test.jpg", "update", {
          from: secondaryGroupHead1,
        }),
      ]);
      ...
      // Log the total execution time for all transactions
      console.log(
        `Total Execution Time for first benign and others too frequent access transactions: ${totalExecutionTime} ms`
      );
