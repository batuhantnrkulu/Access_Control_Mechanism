...
contract(
  ...
  (accounts) => {
    ...
    let accessControlContract1, accessControlContract2, accessControlContract3;
    ...
    beforeEach(async () => {
      ...
      const tx3 = await accessControlFactory.deployAccessControlContract(
        secondaryGroupHead1,
        primaryHead1,
        "movie",
        { from: secondaryGroupHead1 }
      );
      const accAddress3 = tx3.logs[0].args.accAddress;
      accessControlContract3 = await AccessControlContract.at(accAddress3);

      await roleToken.assignAdminRole(admin, accAddress3);
    });
    ...
    it("should penalize for too frequent access and track misbehavior", async () => {
      ...
      console.log(
        "Gas Used for policyAdd from primaryHead1:",
        tx.receipt.gasUsed
      );

      // Add a policy for testing
      tx = await measureFunctionExecutionTime(
        accessControlContract2.policyAdd,
        4,
        "test.mp4",
        "view",
        "allow",
      ...
      console.log(
        "Gas Used for policyAdd from regularMember3:",
        tx.receipt.gasUsed
      );

      // Add a policy for testing
      tx = await measureFunctionExecutionTime(
        accessControlContract3.policyAdd,
        2,
        "test.mp4",
        "view",
        "allow",
      ...
      console.log(
        "Gas Used for policyAdd from secondaryGroupHead1:",
        tx.receipt.gasUsed
      );
      ...
      console.log(
        "Gas Used for first accessControl from secondaryGroupHead1:",
        tx.receipt.gasUsed
      );

      // First valid access
      tx = await measureFunctionExecutionTime(
        accessControlContract2.accessControl,
        "test.mp4",
        "view",
        {
          from: regularMember1,
      ...
      console.log(
        "Gas Used for first accessControl from regularMember1:",
        tx.receipt.gasUsed
      );

      // First valid access
      tx = await measureFunctionExecutionTime(
        accessControlContract3.accessControl,
        "test.mp4",
        "view",
        {
          from: primaryHead1,
      ...
      console.log(
        "Gas Used for first accessControl from primaryHead1:",
        tx.receipt.gasUsed
      );
      ...
      console.log(
        "Gas Used for too frequent accessControl from secondaryGroupHead1:",
        tx.receipt.gasUsed
      );
      ...
      console.log(
        "Gas Used for too frequent accessControl from regularMember1:",
        tx.receipt.gasUsed
      );
      ...
      console.log(
        "Gas Used for too frequent accessControl from primaryHead1:",
        tx.receipt.gasUsed
      );
